                        ...
                        cartItems.map(product =>
                            <div key={product._id} style={{ borderBottom: '1px solid #E4DADA' }} className="py-2">
                                <div className="d-flex justify-content-between align-item-center px-2">
                                    <div onClick={() => addToCart(product)} style={{ width: '14px', height: '18px', backgroundColor: '#D9D9D9', cursor: 'pointer' }} className="col-md-2 fw-bold d-flex justify-content-center align-items-center">+</div>
                                ...
                                <div className="d-flex justify-content-between align-item-center px-2 mt-2">
                                    <div onClick={() => handleRemove(product)} style={{ width: '14px', height: '18px', backgroundColor: '#D9D9D9', cursor: 'pointer' }} className="col-md-2 fw-bold d-flex justify-content-center align-items-center">-</div>
