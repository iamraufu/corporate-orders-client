...
const ProfileNameDropDown = () => {
    ...
    return (
        <div className="dropdown">
            <button style={{ height: '30px', width: '30px', borderRadius: '50%' }} data-bs-toggle="dropdown" aria-expanded="false" className='btn text-white btn-sm bg-danger fw-bold mt-1 dropdown-toggle mx-auto d-block'>{credential?.user?.company_name.slice(0, 1) || ""}</button>
